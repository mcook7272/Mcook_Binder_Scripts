...
*               4.   Patients have LDL-C result >100 within last 2 years (REMOVED)
...
WHERE (
		currenticd10list_x IN ('Z13.6', 'I10', 'E78.0', 'E78.2', 'E78.5', 'Z72.0', 'Z87.891', 'E78.01', 'E78.00', 'T46.6X5A')
		OR currenticd10list_x LIKE 'F17.2%'
		OR currenticd10list_x LIKE 'E66.%'
		OR currenticd10list_x LIKE 'E11.%'
		OR currenticd10list_x LIKE 'E10.%'
		);
...
SELECT departmentkey, DepartmentEpicID
INTO #CCDA11031_dep
...
SELECT count(distinct pd.durablekey) --, res.NumericValue, res.ResultInstant
...
/*
* Patients with lipid-lowering result criteria
*/
...
JOIN #CCDA11031_lip_inc lip ON pd.DurableKey = lip.PatientDurableKey
	AND lip.lipid_therapy_initiation_or_intensification_flag = 1
