...
    #condition_rollup
from 
    PMAP_Analytics.dbo.CURE_ID_CONDITION_OCCURRENCE 
left join
    JHM_OMOP_NoID.dbo.CONCEPT_ancestor on
        descendant_concept_id = CURE_ID_CONDITION_OCCURRENCE.condition_concept_id
left join 
    JHM_OMOP_NoID.dbo.concept on concept.concept_id = CONCEPT_ancestor.ancestor_concept_id
...
    PMAP_Analytics.dbo.CURE_ID_CONDITION_OCCURRENCE 
left join 
    JHM_OMOP_NoID.dbo.concept on concept.concept_id = CURE_ID_CONDITION_OCCURRENCE.condition_concept_id 
) as x1
...
drop table if exists dbo.CURE_ID_Condition_Occurrence_Rare_Removed;
 
SELECT c.condition_occurrence_id, c.person_id,rare.revised_concept_id as condition_concept_id, c.
   ...
   INTO dbo.CURE_ID_Condition_Occurrence_Rare_Removed
   FROM PMAP_Analytics.dbo.CURE_ID_CONDITION_OCCURRENCE  c
   ...
   --DROP TABLE IF EXISTS dbo.CURE_ID_Condition_Occurrence;
