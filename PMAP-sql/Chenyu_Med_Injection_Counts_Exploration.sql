...
select *
from #drug_exposure_within121 d
join #injection_within121 i 
	on d.person_id = i.person_id
	and i.p_date = d.drug_exposure_start_date
where d.person_id = 952415
