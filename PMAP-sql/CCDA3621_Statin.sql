...
having Min(DateDim.DateValue) >= '2016-07-01'
...
as (select distinct CompResult.PatientDurableKey from [CDW].dbo.[LabComponentResultFact] CompResult
...
inner join LDL_Info on LDL_Info.PatientDurableKey = PtDim.DurableKey
