ALTER PROCEDURE dbo.CCDA_3284_Hager_Masking AS

/**********************************************************************************
Author:  mcook49
Date: 2022-03-01
JIRA: CCDA-3284
Description: To run after the projection of CROWNHager data, masking the data for the study team
...
Drop table if exists PMAP_Analytics.dbo.CCDA3284_Hager_csn_Mapping;
Drop table if exists PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_Mapping;
DROP table if exists CROWNHager_Projection.dbo.covid_pmcoe_convalescent_plasma_masked;
DROP table if exists CROWNHager_Projection.dbo.covid_pmcoe_covid_positive_masked;
DROP table if exists CROWNHager_Projection.dbo.curated_Adult_RTAssessment_masked;
DROP table if exists CROWNHager_Projection.dbo.curated_CCPSEI_Specimens_masked;
DROP table if exists CROWNHager_Projection.dbo.curated_covid_immunizations_masked;
DROP table if exists CROWNHager_Projection.dbo.curated_elixhauser_comorbidities_masked;
DROP table if exists CROWNHager_Projection.dbo.curated_Inflam_Markers_masked;
DROP table if exists CROWNHager_Projection.dbo.Curated_IPEvents_masked;
DROP table if exists CROWNHager_Projection.dbo.curated_IPVitals_masked;
DROP table if exists CROWNHager_Projection.dbo.curated_who_status_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_adt_location_history_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_code_status_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_emr_diagnosis_info_masked;--
DROP table if exists CROWNHager_Projection.dbo.derived_encounter_dx_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_enroll_info_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_epic_patient_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_flowsheet_data_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_hosp_billing_dx_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_hosp_billing_px_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_image_procedures_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_immunizations_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_infections_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_inpatient_encounters_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_lab_results_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_med_admin_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_med_orders_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_medical_hx_summary_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_outpatient_encounters_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_problem_list_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_profee_billing_px_masked;
DROP table if exists CROWNHager_Projection.dbo.derived_social_history_changes_masked;
...
SELECT 
	...
	into PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping
FROM (
	SELECT DISTINCT
		t.pat_enc_csn_id "Identity_ID"
	FROM (
		select distinct osler_id, pat_enc_csn_id
		from CROWNHager_Projection.dbo.derived_inpatient_encounters
		union 
		select distinct osler_id, pat_enc_csn_id
		from CROWNHager_Projection.dbo.derived_hosp_billing_dx
		union 
		select distinct osler_id, pat_enc_csn_id
		from CROWNHager_Projection.dbo.curated_Inflam_Markers
		union
		select distinct osler_id, pat_enc_csn_id
		from CROWNHager_Projection.dbo.derived_hosp_billing_px	
		union
		select distinct osler_id, init_pat_enc_csn_id
		from CROWNHager_Projection.dbo.Curated_IPEvents
		union
		select distinct osler_id, pat_enc_csn_id
		from CROWNHager_Projection.dbo.derived_outpatient_encounters
		union
		select distinct osler_id, pat_enc_csn_id
		from CROWNHager_Projection.dbo.derived_image_procedures
		union
		select distinct osler_id, pat_enc_csn_id
		from CROWNHager_Projection.dbo.derived_lab_results
		union
		select distinct osler_id, jab1_csn "pat_enc_csn_id"
		from CROWNHager_Projection.dbo.curated_covid_immunizations
		union
		select distinct osler_id, jab2_csn "pat_enc_csn_id"
		from CROWNHager_Projection.dbo.curated_covid_immunizations
		union
		select distinct osler_id, jab3_csn "pat_enc_csn_id"
		from CROWNHager_Projection.dbo.curated_covid_immunizations
		union
		select distinct osler_id, pat_enc_csn_id
		from CROWNHager_Projection.dbo.derived_med_orders
	) t
 ...
 --osler_id
  SELECT 
	...
	into PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping
FROM (
	SELECT DISTINCT
		osler_id, birth_date
	from CROWNHager_Projection.dbo.derived_epic_patient
 )A;
...
into CROWNHager_Projection.dbo.derived_epic_patient_masked
from CROWNHager_Projection.dbo.derived_epic_patient pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id
...
INTO CROWNHager_Projection.dbo.covid_pmcoe_covid_positive_masked
from CROWNHager_Projection.dbo.covid_pmcoe_covid_positive pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.curated_elixhauser_comorbidities_masked
from CROWNHager_Projection.dbo.curated_elixhauser_comorbidities pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.curated_Inflam_Markers_masked
from CROWNHager_Projection.dbo.curated_Inflam_Markers pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.pat_enc_csn_id = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;

SELECT id.patient_id,map.enc_ID,map2.enc_ID "linked_enc_ID",[event],[start],
[end],who_score_numeric,who_score_grouped,who_score 
INTO CROWNHager_Projection.dbo.curated_who_status_masked
from CROWNHager_Projection.dbo.curated_who_status pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.pat_enc_csn_id = map.Identity_ID
left join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map2 on pat.LINKED_CSN = map2.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_encounter_dx_masked
from CROWNHager_Projection.dbo.derived_encounter_dx pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.pat_enc_csn_id = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_hosp_billing_dx_masked
from CROWNHager_Projection.dbo.derived_hosp_billing_dx pat
left join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.pat_enc_csn_id = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_hosp_billing_px_masked
from CROWNHager_Projection.dbo.derived_hosp_billing_px pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.pat_enc_csn_id = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_inpatient_encounters_masked
from CROWNHager_Projection.dbo.derived_inpatient_encounters pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.pat_enc_csn_id = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_medical_hx_summary_masked
from CROWNHager_Projection.dbo.derived_medical_hx_summary pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_problem_list_masked
from CROWNHager_Projection.dbo.derived_problem_list pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_profee_billing_px_masked
from CROWNHager_Projection.dbo.derived_profee_billing_px pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.pat_enc_csn_id = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.curated_Adult_RTAssessment_masked
from CROWNHager_Projection.dbo.curated_Adult_RTAssessment pat
left join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.PAT_ENC_CSN_ID = map.Identity_ID
left join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map2 on pat.lda_initial_csn = map2.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_code_status_masked
from CROWNHager_Projection.dbo.derived_code_status pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.PAT_ENC_CSN_ID = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_social_history_changes_masked
from CROWNHager_Projection.dbo.derived_social_history_changes pat
left join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.PAT_ENC_CSN_ID = map.Identity_ID
left join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map2 on pat.hx_lnk_enc_csn = map2.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.covid_pmcoe_convalescent_plasma_masked
from CROWNHager_Projection.dbo.covid_pmcoe_convalescent_plasma pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.PAT_ENC_CSN_ID = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;

SELECT id.patient_id,jab1_immune_id,jab1_immune_date,jab1_immunzatn_id,jab1_immune_type,
jab1_imm_historic_adm_yn,jab2_immune_id,jab2_immune_date,
jab2_immunzatn_id,jab2_immune_type,jab2_imm_historic_adm_yn,
jab1_jab2_interval_days,jab1_order_id,map.enc_ID "jab1_csn",jab1_entry_date,
jab1_update_date,jab2_entry_date,jab2_update_date,jab2_order_id,
map2.enc_ID "jab2_csn",jab1_document_id,
jab1_contact_date_real,jab1_line,jab2_document_id,jab2_contact_date_real,
jab2_line,jab3_immune_id,jab3_immune_date,jab3_immunzatn_id,jab3_immune_type,
jab3_imm_historic_adm_yn,jab2_jab3_interval_days,jab3_order_id,
map3.enc_ID "jab3_csn",jab3_entry_date,jab3_update_date,jab3_document_id,
jab3_contact_date_real,jab3_line
INTO CROWNHager_Projection.dbo.curated_covid_immunizations_masked
from CROWNHager_Projection.dbo.curated_covid_immunizations pat
left join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.jab1_csn = map.Identity_ID
left join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map2 on pat.jab2_csn = map2.Identity_ID
left join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map3 on pat.jab3_csn = map3.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.curated_ipevents_masked
from CROWNHager_Projection.dbo.curated_ipevents pat
left join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.INIT_PAT_ENC_CSN_ID = map.Identity_ID
left join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map2 on pat.LINKED_CSN = map2.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.curated_ipvitals_masked
from CROWNHager_Projection.dbo.curated_ipvitals pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_adt_location_history_masked
from CROWNHager_Projection.dbo.derived_adt_location_history pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.PAT_ENC_CSN_ID = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_enroll_info_masked
from CROWNHager_Projection.dbo.derived_enroll_info pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_flowsheet_data_masked
from CROWNHager_Projection.dbo.derived_flowsheet_data pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.PAT_ENC_CSN_ID = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_image_procedures_masked
from CROWNHager_Projection.dbo.derived_image_procedures pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.PAT_ENC_CSN_ID = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_immunizations_masked
from CROWNHager_Projection.dbo.derived_immunizations pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.PAT_ENC_CSN_ID = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_infections_masked
from CROWNHager_Projection.dbo.derived_infections pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_lab_results_masked
from CROWNHager_Projection.dbo.derived_lab_results pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.PAT_ENC_CSN_ID = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_med_admin_masked
from CROWNHager_Projection.dbo.derived_med_admin pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.PAT_ENC_CSN_ID = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;

SELECT id.patient_id,map.enc_ID,MedName,MedDisplayName,Dose,Frequency,
Sig,OrderingDate,OrderType,StartDate,EndDate,DiscontinuationReason,
TheraClass,PharmClass,PharmSubClass,CurrentMed
INTO CROWNHager_Projection.dbo.derived_med_orders_masked
from CROWNHager_Projection.dbo.derived_med_orders pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.PAT_ENC_CSN_ID = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_outpatient_encounters_masked
from CROWNHager_Projection.dbo.derived_outpatient_encounters pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_csn_mapping map on pat.PAT_ENC_CSN_ID = map.Identity_ID
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;

SELECT id.patient_id,subject_number,collection_date,specimen_type
INTO CROWNHager_Projection.dbo.curated_CCPSEI_Specimens_masked
from CROWNHager_Projection.dbo.curated_CCPSEI_Specimens pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;
...
INTO CROWNHager_Projection.dbo.derived_emr_diagnosis_info_masked
from CROWNHager_Projection.dbo.derived_emr_diagnosis_info pat
inner join PMAP_Analytics.dbo.CCDA3284_Hager_osler_id_mapping id on id.osler_id = pat.osler_id;

--Drop original tables

DROP table if exists CROWNHager_Projection.dbo.covid_pmcoe_convalescent_plasma;
DROP table if exists CROWNHager_Projection.dbo.covid_pmcoe_covid_positive;
DROP table if exists CROWNHager_Projection.dbo.curated_Adult_RTAssessment;
DROP table if exists CROWNHager_Projection.dbo.curated_CCPSEI_Specimens;
DROP table if exists CROWNHager_Projection.dbo.curated_covid_immunizations;
DROP table if exists CROWNHager_Projection.dbo.curated_elixhauser_comorbidities;
DROP table if exists CROWNHager_Projection.dbo.curated_Inflam_Markers;
DROP table if exists CROWNHager_Projection.dbo.Curated_IPEvents;
DROP table if exists CROWNHager_Projection.dbo.curated_IPVitals;
DROP table if exists CROWNHager_Projection.dbo.curated_who_status;
DROP table if exists CROWNHager_Projection.dbo.derived_adt_location_history;
DROP table if exists CROWNHager_Projection.dbo.derived_code_status;
DROP table if exists CROWNHager_Projection.dbo.derived_emr_diagnosis_info;
DROP table if exists CROWNHager_Projection.dbo.derived_encounter_dx;
DROP table if exists CROWNHager_Projection.dbo.derived_enroll_info;
DROP table if exists CROWNHager_Projection.dbo.derived_epic_patient;
DROP table if exists CROWNHager_Projection.dbo.derived_flowsheet_data;
DROP table if exists CROWNHager_Projection.dbo.derived_hosp_billing_dx;
DROP table if exists CROWNHager_Projection.dbo.derived_hosp_billing_px;
DROP table if exists CROWNHager_Projection.dbo.derived_image_procedures;
DROP table if exists CROWNHager_Projection.dbo.derived_immunizations;
DROP table if exists CROWNHager_Projection.dbo.derived_infections;
DROP table if exists CROWNHager_Projection.dbo.derived_inpatient_encounters;
DROP table if exists CROWNHager_Projection.dbo.derived_lab_results;
DROP table if exists CROWNHager_Projection.dbo.derived_med_admin;
DROP table if exists CROWNHager_Projection.dbo.derived_med_orders;
DROP table if exists CROWNHager_Projection.dbo.derived_medical_hx_summary;
DROP table if exists CROWNHager_Projection.dbo.derived_outpatient_encounters;
DROP table if exists CROWNHager_Projection.dbo.derived_problem_list;
DROP table if exists CROWNHager_Projection.dbo.derived_profee_billing_px;
DROP table if exists CROWNHager_Projection.dbo.derived_social_history_changes;
